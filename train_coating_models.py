...
input_path = os.path.join(script_dir, "data_cleaned", "coating_model_features.csv")
...
if __name__ == "__main__":
    ...
    # Save metrics to existing report path (append or separate)
    report_path = os.path.join(script_dir, "training_metrics_coating.txt")
